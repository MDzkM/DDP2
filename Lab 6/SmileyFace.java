...
public class SmileyFace extends Application {
	...
	public void start(Stage stage) {
		...
		Circle leftEye = new Circle(164, 100, 10); // create circle at x, y coordinates with z radius
		leftEye.setFill(Color.CYAN); // set circle fill color
		leftEye.setStroke(Color.BLUE); // set circle stroke
